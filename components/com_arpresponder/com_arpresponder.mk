...
cfiles := $(wildcard ${CURRENT_DIR}/com_arpresponder.cxx)
...
com_arpresponder_HFILES := $(patsubst ${SOURCE_DIR}/%,%,$(wildcard ${SOURCE_DIR}/include/*.h))
com_arpresponder_rumpbin := com_arpresponder

#-include  ${SOURCE_DIR}/include/click/config.h
#click: $(CLICK_LIBS) $(ELEMENTS_OBJS) $(ELEMENTS_HHFILES) $(cfiles) $(hfiles) 	

com_arpresponder: $(cfiles) $(hfiles) \
	...
	$(SOURCE_DIR)/elements/camkes/camkes_arpresponder.o \
	$(SOURCE_DIR)/elements/camkes/camkes_arpresponder.hh \
