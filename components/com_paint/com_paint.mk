...
cfiles := $(wildcard ${CURRENT_DIR}/com_paint.cxx)
...
com_paint_HFILES := $(patsubst ${SOURCE_DIR}/%,%,$(wildcard ${SOURCE_DIR}/include/*.h))
com_paint_rumpbin := com_paint

#-include  ${SOURCE_DIR}/include/click/config.h
#click: $(CLICK_LIBS) $(ELEMENTS_OBJS) $(ELEMENTS_HHFILES) $(cfiles) $(hfiles) 	

com_paint: $(cfiles) $(hfiles) \
