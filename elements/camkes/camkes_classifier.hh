...
#include "../standard/classification.hh"
#include <porttype.h>
CLICK_DECLS

/*
 * =c
 * Camkes_Classifier(pattern1, ..., patternN)
 * =s classification
 * classifies packets by contents
 * =d
 * Classifies packets. The Camkes_Classifier has N outputs, each associated with the
 ...
 * =n
 *
 * The IPCamkes_Classifier and IPFilter elements have a friendlier syntax if you are
 * classifying IP packets.
 *
 * =e
 * For example,
 *
 *   Camkes_Classifier(12/0806 20/0001,
 *              12/0806 20/0002,
 *              12/0800,
 *              -);
 *
 ...
 *
 * =h program read-only
 * Returns a human-readable definition of the program the Camkes_Classifier element
 ...
 * classifier pattern.
 *
 * The Camkes_Classifier patterns above compile into the following program:
 *
 ...
 *   alignment offset 0
 *
 * =a IPCamkes_Classifier, IPFilter */
